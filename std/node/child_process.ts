...
import { run as runSync, RunRequest, RunResponse } from "../../cli/js/ops/process.ts";
...
interface cp_interface {
    ChildProcess: never;
    exec: (cmd: string,options?: cp_opts_interface, callback?: (error: Error, stdout?: Stdout, stderr?: Stderr) => any) => Promise<RunResponse>;
    execFile: ( file: string | File, args?: string[], options?: cp_opts_interface, callback?: ( error: Error, stdout?: Stdout, stderr?: Stderr ) => any ) => Promise<RunResponse>;
}
